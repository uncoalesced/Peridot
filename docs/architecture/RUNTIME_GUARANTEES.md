...
This document defines the strict operational boundaries, degradation policies, and failure-isolation guarantees enforced by the Peridot v1.5.3 Central Nervous System (FSM). Peridot operates on the principle that inference throughput is secondary to system stability.
